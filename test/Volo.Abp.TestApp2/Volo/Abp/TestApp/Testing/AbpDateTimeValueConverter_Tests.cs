...
namespace Volo.Abp.TestApp2.Testing
{
        ...
        where TStartupModule : IAbpModule
    {
        ...
        {
            var personId = Guid.Parse("4125582e-d100-4c27-aa84-e4de85830dca").ToString();
        ...
        public async Task DateTime_Kind_Should_Be_Normalized_To_UTC_View_Test()
        {
            ...
            await _personRepository.InsertAsync(new Person(Guid.NewGuid().ToString(), personName, 18)
            {
                Birthday = DateTime.Parse("2020-01-01 00:00:00"),
                LastActive = DateTime.Parse("2020-01-01 00:00:00"),
            }, true);
